---
description: A collection of data types returned by the API
---

# 🧬 Data Types

{% hint style="info" %}
These data types are incomplete, but will be referenced in the response bodies of the [api-reference](../api-reference/ "mention")
{% endhint %}

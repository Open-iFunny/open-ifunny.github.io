...
{% swagger-response status="200: OK" description="Subscribed" %}
{% tabs %}
{% tab title="JSON" %}
```json
...
{% swagger method="put" path="/users/my/blocked/:user_id" baseUrl="https://api.ifunny.mobi/v4" summary="Block User" %}
...
One of: user, installation
{% endswagger-parameter %}

{% swagger-response status="200: OK" description="User blocked" %}
No response body.
{% endswagger-response %}
...
{% swagger method="delete" path="/users/my/blocked/:user_id" baseUrl="https://api.ifunny.mobi/v4" summary="Unblock User" %}
...
{% swagger-response status="200: OK" description="User unblocked" %}
No response body.
{% endswagger-response %}
...
{% swagger method="put" path="/users/:user_id/abuses" baseUrl="https://api.ifunny.mobi/v4" summary="Report User" %}

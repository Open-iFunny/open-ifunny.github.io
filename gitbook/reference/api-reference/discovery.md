...
{% swagger method="post" path="/explore/compilation/:id" baseUrl="https://api.ifunny.mobi/v4" summary="Get Explore Compilation" %}
...
Compilation ID (see EXPLORE_COMPILATION_IDS in client types).
...
{% swagger-response status="200: OK" description="Compilation page" %}
{% tabs %}
{% tab title="JSON" %}
```json
...
{% swagger method="get" path="/digest_groups" baseUrl="https://api.ifunny.mobi/v4" summary="Get Weekly Digest Groups" %}
...
{% swagger-parameter in="query" name="comments" type="Number" %}
1 to include comment detail data.

One of: 0, 1
{% endswagger-parameter %}

{% swagger-parameter in="query" name="contents" type="Number" %}
1 to include content detail data.

One of: 0, 1
{% endswagger-parameter %}

{% swagger-response status="200: OK" description="Digest groups page" %}
{% tabs %}
{% tab title="JSON" %}
```json
...
{% swagger method="get" path="/digests/:digest_id/reads/:count" baseUrl="https://api.ifunny.mobi/v4" summary="Mark Digest Posts as Read" %}
...
{% swagger-parameter in="path" name="digest_id" type="String" required="true" %}

{% endswagger-parameter %}

{% swagger-parameter in="path" name="count" type="Number" required="true" %}
How many leading posts of the digest to mark read.
{% endswagger-parameter %}

{% swagger-response status="200: OK" description="Read state updated" %}
No response body.
{% endswagger-response %}
